...
Add `Configuration` to the dependencies within your application's `Package.swift` file. Substitute `"x.x.x"` with the latest `Configuration` [release](https://github.com/Kitura-Next/Configuration/releases).

```swift
.package(url: "https://github.com/Kitura-Next/Configuration.git", from: "x.x.x")
```
...
**NOTE:** Currently, `Configuration` only supports JSON and PLIST formats for resources loaded from `Data`, file, or `URL`. You can write a [custom deserializer](https://kitura-next.github.io/Configuration/Protocols/Deserializer.html) to parse additional formats.
...
## API Documentation
For more information visit our [API reference](https://kitura-next.github.io/Configuration/index.html).

## License
This library is licensed under Apache 2.0. Full license text is available in [LICENSE](https://github.com/Kitura-Next/Configuration/blob/master/LICENSE).
